const questions = [
    ...
    { question: "Quel est le plus grand continent ?", answers: ["Afrique", "Asie", "Europe", "Amérique"], correct: 1 },
    { question: "Quelle est la capitale de l’Argentine ?", answers: ["Buenos Aires", "Cordoba", "Rosario", "Mendoza"], correct: 0 },
    { question: "Quel est l’animal national de l’Australie ?", answers: ["Kangourou", "Koala", "Émeu", "Dingo"], correct: 0 },
    { question: "Quelle planète est connue pour ses anneaux ?", answers: ["Saturne", "Jupiter", "Mars", "Neptune"], correct: 0 },
    { question: "Quel est le plus long fleuve d’Afrique ?", answers: ["Niger", "Congo", "Nil", "Zambèze"], correct: 2 },
    { question: "Quel est le plus haut volcan du monde ?", answers: ["Ojos del Salado", "Cotopaxi", "Kilimandjaro", "Vesuvius"], correct: 0 },
    { question: "Combien de faces a un cube ?", answers: ["4", "6", "8", "12"], correct: 1 },
    { question: "Quel pays possède la ville de Marrakech ?", answers: ["Algérie", "Maroc", "Tunisie", "Libye"], correct: 1 },
    { question: "Quelle est la plus grande île de Méditerranée ?", answers: ["Sicile", "Sardaigne", "Chypre", "Crète"], correct: 0 },
    { question: "Quel est le métal le plus précieux ?", answers: ["Argent", "Or", "Platine", "Cuivre"], correct: 1 },
    { question: "Quel est le pays le plus peuplé d’Afrique ?", answers: ["Égypte", "Nigeria", "Éthiopie", "Afrique du Sud"], correct: 1 },
    { question: "Quelle est la capitale de la Norvège ?", answers: ["Oslo", "Bergen", "Trondheim", "Stavanger"], correct: 0 },
    { question: "Quel animal produit le miel ?", answers: ["Abeille", "Fourmi", "Guêpe", "Papillon"], correct: 0 },
    { question: "Combien de joueurs sur un terrain de rugby ?", answers: ["11", "13", "15", "17"], correct: 2 },
    { question: "Quel est le plus long fleuve d’Amérique du Sud ?", answers: ["Amazon", "Orénoque", "São Francisco", "Paraná"], correct: 0 },
    { question: "Quel pays a pour capitale Vienne ?", answers: ["Allemagne", "Autriche", "Hongrie", "Suisse"], correct: 1 },
    { question: "Quel est l’instrument de musique à cordes le plus grand ?", answers: ["Violon", "Contrebasse", "Guitare", "Harpe"], correct: 1 },
    { question: "Quel est le plus grand désert du monde ?", answers: ["Sahara", "Gobi", "Kalahari", "Antarctique"], correct: 3 },
    { question: "Quel est le plus petit os du corps humain ?", answers: ["Étrier", "Malleus", "Incus", "Fémur"], correct: 0 },
    { question: "Quelle est la capitale de la Finlande ?", answers: ["Helsinki", "Espoo", "Tampere", "Turku"], correct: 0 },
    { question: "Quel est le plus grand lac d’Amérique du Nord ?", answers: ["Michigan", "Huron", "Supérieur", "Ontario"], correct: 2 },
    { question: "Quel pays est surnommé le pays des mille lacs ?", answers: ["Norvège", "Finlande", "Suède", "Canada"], correct: 1 },
    { question: "Quel animal est considéré comme le roi des animaux ?", answers: ["Lion", "Tigre", "Éléphant", "Aigle"], correct: 0 },
    { question: "Quel pays est connu pour les tulipes ?", answers: ["Allemagne", "Pays-Bas", "Belgique", "Danemark"], correct: 1 },
    { question: "Quel pays a inventé le papier ?", answers: ["Égypte", "Chine", "Grèce", "Inde"], correct: 1 },
    { question: "Combien de pattes a un insecte ?", answers: ["4", "6", "8", "10"], correct: 1 },
    { question: "Quelle est la capitale de l’Indonésie ?", answers: ["Bali", "Jakarta", "Surabaya", "Bandung"], correct: 1 },
    { question: "Quelle est la monnaie de la Suisse ?", answers: ["Euro", "Franc suisse", "Dollar", "Livre"], correct: 1 },
    { question: "Quel est le plus grand océan du monde ?", answers: ["Atlantique", "Pacifique", "Indien", "Arctique"], correct: 1 },
    { question: "Quel pays a pour capitale Budapest ?", answers: ["Roumanie", "Hongrie", "Slovaquie", "Autriche"], correct: 1 },
    { question: "Quel est le plus grand mammifère terrestre ?", answers: ["Éléphant", "Girafe", "Hippopotame", "Rhinocéros"], correct: 0 },
    { question: "Quel pays est le plus peuplé du monde ?", answers: ["Inde", "Chine", "États-Unis", "Indonésie"], correct: 1 },
    { question: "Quel est le métal liquide à température ambiante ?", answers: ["Mercure", "Plomb", "Aluminium", "Fer"], correct: 0 },
    { question: "Quelle est la capitale de l’Espagne ?", answers: ["Madrid", "Barcelone", "Séville", "Valence"], correct: 0 },
    { question: "Quel pays a la forme d’un botté ?", answers: ["Espagne", "Italie", "Grèce", "Portugal"], correct: 1 },
    { question: "Quel est le plus long fleuve d’Europe ?", answers: ["Danube", "Volga", "Rhin", "Loire"], correct: 1 },
    { question: "Quel pays a pour capitale Ottawa ?", answers: ["Canada", "États-Unis", "Australie", "Royaume-Uni"], correct: 0 },
    { question: "Quelle planète est la plus proche de la Terre ?", answers: ["Mercure", "Venus", "Mars", "Jupiter"], correct: 1 },
    { question: "Quel est le plus haut sommet d’Europe ?", answers: ["Mont Blanc", "Elbrouz", "Matterhorn", "Grossglockner"], correct: 1 },
    { question: "Quel pays est célèbre pour ses pyramides ?", answers: ["Égypte", "Mexique", "Chine", "Inde"], correct: 0 },
    { question: "Quel animal pond des œufs ?", answers: ["Chat", "Cochon", "Oiseau", "Vache"], correct: 2 },
    { question: "Quel pays est surnommé le pays du Soleil-Levant ?", answers: ["Japon", "Chine", "Corée", "Thaïlande"], correct: 0 },
    { question: "Combien de côtés a un pentagone ?", answers: ["4", "5", "6", "7"], correct: 1 },
    { question: "Quel pays est le plus grand d’Amérique du Sud ?", answers: ["Argentine", "Brésil", "Chili", "Colombie"], correct: 1 },
    { question: "Quelle est la capitale de la Grèce ?", answers: ["Athènes", "Thessalonique", "Patras", "Larissa"], correct: 0 },
    { question: "Quel est l’organe principal de la respiration ?", answers: ["Cœur", "Poumon", "Foie", "Rein"], correct: 1 },
    { question: "Quelle planète est surnommée la planète rouge ?", answers: ["Mercure", "Venus", "Mars", "Jupiter"], correct: 2 },
    { question: "Quel pays a pour capitale Moscou ?", answers: ["Pologne", "Russie", "Ukraine", "Biélorussie"], correct: 1 },
    { question: "Quel est le plus rapide animal terrestre ?", answers: ["Lion", "Guépard", "Tigre", "Éléphant"], correct: 1 },
    { question: "Quel est le symbole chimique de l’or ?", answers: ["Ag", "Au", "Pb", "Fe"], correct: 1 },
    { question: "Quel est le principal gaz nécessaire à la respiration ?", answers: ["Hydrogène", "Oxygène", "Azote", "CO2"], correct: 1 },
    { question: "Combien de côtés a un hexagone ?", answers: ["5", "6", "7", "8"], correct: 1 },
    { question: "Quel est l’animal marin le plus grand ?", answers: ["Orque", "Requin", "Baleine bleue", "Calmar géant"], correct: 2 },
    { question: "Quelle est la monnaie du Japon ?", answers: ["Yen", "Dollar", "Euro", "Livre"], correct: 0 },
    { question: "Quel est le plus long fleuve du monde ?", answers: ["Nil", "Amazon", "Yangzi", "Mississippi"], correct: 1 },
    { question: "Combien de planètes compte le système solaire ?", answers: ["7", "8", "9", "10"], correct: 1 },
    { question: "Quel est l’animal volant le plus rapide ?", answers: ["Aigle", "Faucon pèlerin", "Colibri", "Hirondelle"], correct: 1 },
    { question: "Quelle est la capitale de la Suède ?", answers: ["Stockholm", "Gothenburg", "Malmö", "Uppsala"], correct: 0 },
    { question: "Quel pays a pour capitale Helsinki ?", answers: ["Norvège", "Finlande", "Suède", "Danemark"], correct: 1 },
    { question: "Quel est le plus grand désert chaud ?", answers: ["Sahara", "Gobi", "Kalahari", "Arabique"], correct: 0 },
    { question: "Quel pays est célèbre pour la Tour Eiffel ?", answers: ["Italie", "France", "Espagne", "Angleterre"], correct: 1 },
    { question: "Quel métal a pour symbole Fe ?", answers: ["Fer", "Argent", "Or", "Plomb"], correct: 0 },
    { question: "Quel animal est capable de changer de couleur ?", answers: ["Caméléon", "Lion", "Éléphant", "Girafe"], correct: 0 },
    { question: "Quel est le plus haut sommet du monde ?", answers: ["K2", "Mont Everest", "Kangchenjunga", "Lhotse"], correct: 1 },
    { question: "Combien de dents un adulte possède-t-il normalement ?", answers: ["28", "30", "32", "34"], correct: 2 },
    { question: "Quelle planète est connue pour sa couleur bleue ?", answers: ["Neptune", "Mars", "Vénus", "Jupiter"], correct: 0 },
    { question: "Quel pays est célèbre pour la pizza et les pâtes ?", answers: ["France", "Italie", "Espagne", "Grèce"], correct: 1 }
];
